...
const About3 = () => {
  ...
  return (
    <div className="cont mycontainer px-6 md:px-24">
      <div className="image-wrapper pt-12 md:pt-36">
        <div className='flex my-auto w-full h-[60vh] md:h-[90vh] mx-auto overflow-hidden rounded-lg md:rounded-2xl relative' >
          <img src={large} alt="large" className='flex absolute h-full w-full object-cover  ' />
          <p className='flex z-20 justify-center items-center mx-auto text-xl md:text-5xl font-normal  max-w-6xl text-center !leading-snug'>“With the brush of technology, the colors of design, and the canvas of strategy, we paint masterpieces.”</p>
        </div>
      </div>
    </div>
  );
