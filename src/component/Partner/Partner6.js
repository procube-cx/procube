...
const Partner6 = () => {
    ...
    return (
        <div className='w-full px-6 md:px-24 pt-6  min-h-screen md:max-h-[900px] md:pt-16' >
            <AnimatedParagraph className='w-full md:w-full font-normal text-4xl md:text-8xl !leading-tight uppercase text-center'>Frequently Asked Questions</AnimatedParagraph>
