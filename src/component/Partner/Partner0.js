...
const Partner0 = () => {
    ...
    return (
        <div className="px-6 md:px-24 pt-24 md:pt-32">
            ...
            <img src={large} alt="large" className='flex my-auto w-full mx-auto rounded-lg md:rounded-3xl h-[65vh] md:h-[90vh] md:object-top' style={{ objectPosition: '70%', objectFit: 'cover' }} />
        </div>
    );
};
