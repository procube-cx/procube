...
const Partner0 = () => {
    ...
    return (
        <div className="px-6 md:px-24 pb-5 md:pb-20 pt-24 md:pt-32">
            <AnimatedParagraph className='font-normal text-4xl md:text-7xl max-w-4xl text-center mx-auto pb-5 md:pb-20 uppercase !leading-tight'>Crafting Exceptional Digital Products</AnimatedParagraph>
