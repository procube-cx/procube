...
const Partner4 = () => {
    ...
    return (
        <div className='w-full px-6 md:px-24 min-h-screen py-6 md:py-12' ref={ref}>
            <AnimatedParagraph className='w-full md:w-full font-normal text-4xl md:text-8xl !leading-tight uppercase text-center pb-10 md:pb-[70px]'>How do I get started?</AnimatedParagraph>
            <div className='w-full flex flex-col-reverse md:flex-row-reverse overflow-hidden gap-x-16 gap-y-10'>
