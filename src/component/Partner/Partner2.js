...
const Partner2 = () => {
  return (
    <div className='flex flex-col md:flex-row w-full h-full py-4 md:py-20 px-6 md:px-36 gap-y-12 overflow-hidden md: gap-x-14'>
