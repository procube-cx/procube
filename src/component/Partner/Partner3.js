...
const Partner3 = () => {
  ...
  return (
    <div className='px-6 md:px-24 md:pb-20 pt-24 md:pt-32'>
      <p className='font-normal text-4xl md:text-7xl max-w-5xl text-center mx-auto py-5 md:pb-20 uppercase !leading-tight'>Who might find our services appealing?</p>
