...
const Landing4 = () => {
    ...
    return (
        <div className='grid grid-cols-5 md:grid-cols-11 w-full px-6 md:px-24 py-6 md:py-10 gap-x-28 h-screen max-h-[900px] overflow-y-hidden'>
            <motion.div
                ref={ref}
            ...
            >
                <p className='font-normal text-4xl text-[120px] md:!leading-tight uppercase'>we build brands</p>
