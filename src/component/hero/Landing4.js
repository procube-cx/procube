...
const Landing4 = () => {
    ...
    return (
        <div className='grid grid-cols-3 md:grid-cols-11 w-full px-6 md:px-24 py-6 md:py-10 gap-x-28 md:min-h-screen max-h-[900px] overflow-y-hidden overflow-x-hidden'>
            <motion.div
                ref={ref}
            ...
            >
                <p className='font-normal text-5xl md:text-[120px] md:!leading-tight uppercase'>we build brands</p>
            ...
            >
                <p className='font-normal text-5xl md:text-[120px] !leading-tight uppercase italic'>Drive Change</p>
            </motion.div>
