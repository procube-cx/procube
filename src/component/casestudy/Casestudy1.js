                ...
                <>
                    {detail.description ?
                        (
                            ...
                            <div key={index} className='grid grid-span-2 gap-y-2 md:gap-y-4 py-4 md:py-12 bg-[#1A1A1A] px-6 md:px-24'>
                                <p className='col-span-2 text-xl md:text-5xl uppercase md:px-24'>{detail.title}</p>
                                {detail.description2 && detail.description2.map((item, idx) => (
                                    <>
                                        <div className='flex flex-col gap-y-5 md:gap-y-10 md:px-24 col-span-1'>
                                            <p key={idx} className='text-xs md:text-lg opacity-60'>{item.title}</p>
